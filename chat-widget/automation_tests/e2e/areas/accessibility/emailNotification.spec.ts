...
/**
 * ADO 5983596 — Success notification is not announced immediately after
 * activating Send to email chat transcript; screen reader reads entire
 * transcript first.
 *
...
describe("email transcript notification (ADO 5983596)", () => {
